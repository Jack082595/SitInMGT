			...
			<div class="row">
					 <div class="col-md-6">
						...
						<?php if($get_info['stat'] == 1)
									echo "<div class='alert alert-success text-center' class='stat' style='max-width:300px'>Status: ACTIVE</div>";
								else
									echo "<div class='alert alert-warning text-center' class='stat' style='max-width:300px'>Status: INACTIVE</div>";
						  ?>
					 </div>
					 <div class="col-md-6">
